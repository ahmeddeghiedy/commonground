...
4. Click **Run the 3-minute demo**. Its readiness card should say **17 WebMCP tools registered**.
...
- **Tool count is below 17:** hard-refresh once. If still wrong, use a fresh browser profile; registration is cleaned up on unmount.
