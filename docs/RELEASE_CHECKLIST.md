...
- [x] `pnpm verify:webmcp` — 15 tools registered, read executed, visible reversible write verified.
...
- [ ] Capture a hero screenshot and a WebMCP DevTools/Inspector screenshot showing all 15 tools.
