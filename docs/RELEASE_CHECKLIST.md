...
- [x] `pnpm verify:webmcp` — 14 tools registered, read executed, visible reversible write verified.
...
- [ ] Capture a hero screenshot and a WebMCP DevTools/Inspector screenshot showing all 14 tools.
